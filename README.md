...
flowchart LR
    ...
    PLUS3 --> PLUS4(("+"))
    PAX["Troops\nCount × 100kg\nPAYLOAD"] --> PLUS4
    PLUS4 --> GW["Gross Weight"]
    GW --> CHECK{"GW ≤ MTOW?"}
    CHECK -->|"Ya"| GO["✅ GO"]
    CHECK -->|"Tidak"| REDUCE["❌ Reduce Payload\natau ganti aset"]

    style GO fill:#166534,stroke:#4ade80,color:#4ade80
    style REDUCE fill:#7f1d1d,stroke:#ef4444,color:#ef4444
```

---

## 6. Output Structure (6 Pilar per COA)

```mermaid
flowchart TD
    COA["COA Object"] --> P1["1️⃣ Header & Metadata\nIdentity · Comms · ROE · Objectives"]
    COA --> P2["2️⃣ Strategic Summary & Scoring\nScore 0-100 · Threat · Risk · Summary ×3"]
    COA --> P3["3️⃣ COA Analysis\nStrengths · Weaknesses · Terrain\nEnvironment · AOI · Threat"]
    COA --> P4["4️⃣ Technical Validation\nM&B · Performance · Fuel · Hard Gates"]
    COA --> P5["5️⃣ Resource & Unit Tasking\nAssets · Health · Crew · Pax · Modules"]
    COA --> P6["6️⃣ Operation Phases & Navigation\nPhases · Timeline · Routes · Map"]
    COA --> SIM["🎬 Simulation\nUnits · Path · Events · Phases"]

    style P1 fill:#1e293b,stroke:#facc15,color:#facc15
    style P2 fill:#1e293b,stroke:#fb923c,color:#fb923c
    style P3 fill:#1e293b,stroke:#38bdf8,color:#38bdf8
    style P4 fill:#1e293b,stroke:#f43f5e,color:#f43f5e
    style P5 fill:#1e293b,stroke:#4ade80,color:#4ade80
    style P6 fill:#1e293b,stroke:#a78bfa,color:#a78bfa
    style SIM fill:#1e293b,stroke:#06b6d4,color:#06b6d4
```
